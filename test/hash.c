...
CUTEST(hash, md5) {
  const ubyte_t hash_etalon_1[] = {
    144, 1, 80, 152, 60, 210, 79, 176,
    214, 150, 63, 125, 40, 225, 127, 114
  };
  const ubyte_t hash_etalon_2[] = {
    130, 21, 239, 7, 150, 162, 11, 202,
    170, 225, 22, 211, 135, 108, 102, 74
  };
  const ubyte_t hash_etalon_3[] = {
    119, 7, 214, 174, 78, 2, 124, 112,
...
CUTEST(hash, sh1) {
  ...
  const ubyte_t hash_etalon_2[] = {
    132, 152, 62, 68, 28, 59, 210, 110,
    186, 174, 74, 161, 249, 81, 41, 229,
    229, 70, 112, 241
  };
  const ubyte_t hash_etalon_3[] = {
    52, 170, 151, 60, 212, 196, 218, 164,
...
CUTEST(hash, sha2_384) {
  const ubyte_t
    hash_etalon_1[] = {
    203, 0, 117, 63, 69, 163, 94, 139, 181, 160, 61, 105,
  ...
  const ubyte_t
    hash_etalon_2[] = {
    51, 145, 253, 221, 252, 141, 199, 57, 55, 7, 166, 91,
  ...
  const ubyte_t
    hash_etalon_3[] = {
    157, 14, 24, 9, 113, 100, 116, 203, 8, 110, 131, 78,
...
CUTEST(hash, sha3_384) {
  const ubyte_t
    hash_etalon_1[] = {
    236, 1, 73, 130, 136, 81, 111, 201, 38, 69, 159, 88,
  ...
  const ubyte_t
    hash_etalon_2[] = {
    153, 28, 102, 87, 85, 235, 58, 75, 107, 189, 251, 117,
  ...
  const ubyte_t
    hash_etalon_3[] = {
    238, 233, 226, 77, 120, 193, 133, 83, 55, 152, 52, 81,
...
main(int ac, char **av) {
  ...
  CUTEST_PASS(hash, nomem);
  CUTEST_PASS(hash, invalid);
  CUTEST_PASS(hash, md5);
  CUTEST_PASS(hash, sh1);
  CUTEST_PASS(hash, sha2_224);
  CUTEST_PASS(hash, sha2_256);
  CUTEST_PASS(hash, sha2_384);
  CUTEST_PASS(hash, sha2_512);
  CUTEST_PASS(hash, sha3_224);
  CUTEST_PASS(hash, sha3_256);
  CUTEST_PASS(hash, sha3_384);
  CUTEST_PASS(hash, sha3_512);
  CUTEST_PASS(hash, gost3411_94);
  return EXIT_SUCCESS;
}
