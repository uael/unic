...
p_atomic_pointer_get(const volatile void *atomic) {
  ...
  return (ppointer) __atomic_load_8(
    PATOMIC_SIZE_CAST ((const volatile psize *) atomic), __ATOMIC_SEQ_CST);
#else
...
p_atomic_pointer_set(volatile void *atomic,
  ppointer val) {
#if (PLIBSYS_SIZEOF_VOID_P == 8)
  __atomic_store_8(PATOMIC_SIZE_CAST ((volatile psize *) atomic), (psize) val,
    __ATOMIC_SEQ_CST);
#else
...
p_atomic_pointer_compare_and_exchange(volatile void *atomic,
  ...
  return (pboolean) __atomic_compare_exchange_n(
    PATOMIC_SIZE_CAST ((volatile psize *) atomic),
    (psize *) &tmp_pointer,
...
p_atomic_pointer_add(volatile void *atomic,
  pssize val) {
  return (pssize) __atomic_fetch_add((volatile pssize *) atomic, val,
    __ATOMIC_SEQ_CST);
}
...
p_atomic_pointer_and(volatile void *atomic,
  psize val) {
  return (psize) __atomic_fetch_and((volatile psize *) atomic, val,
    __ATOMIC_SEQ_CST);
}
...
p_atomic_pointer_or(volatile void *atomic,
  psize val) {
  return (psize) __atomic_fetch_or((volatile pssize *) atomic, val,
    __ATOMIC_SEQ_CST);
}
...
p_atomic_pointer_xor(volatile void *atomic,
  psize val) {
  return (psize) __atomic_fetch_xor((volatile pssize *) atomic, val,
    __ATOMIC_SEQ_CST);
}
