 ...
 *
 * Use u_dl_new() to load a shared library and
 * u_dl_get_symbol() to retrieve a pointer to a symbol within it.
 * Close the library after usage with u_dl_free().
 *
 ...
 * error result using u_dl_get_last_error().
 */
U_API fn_addr_t
