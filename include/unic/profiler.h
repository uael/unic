 ...
 *
 * To start using a profiler create a new one with u_profiler_new() call
 * and u_profiler_elapsed_usecs() to get elapsed time since the creation.
 * If you need to reset a profiler use u_profiler_reset(). Remove a
 * profiler with u_profiler_free().
 */
#ifndef U_PROFILER_H__
# define U_PROFILER_H__
