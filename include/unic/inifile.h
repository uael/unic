 ...
 * will be splitted.
 *
 * To parse a file, create #inifile_t with u_inifile_new() and then parse it
 * with the u_inifile_parse() routine.
 *
 ...
 * @endcode
 */
#ifndef U_INIFILE_H__
# define U_INIFILE_H__
 ...
 */
U_API bool
u_inifile_parse(inifile_t *file, err_t **error);
 ...
 * @since 0.0.1
 * @note It's a caller responsibility to u_free() each returned string and to
 * free the returned list with u_list_free().
 */
U_API list_t *
 ...
 */
U_API list_t *
u_inifile_keys(const inifile_t *file, const byte_t *section);
 ...
 */
U_API bool
u_inifile_is_key_exists(const inifile_t *file, const byte_t *section,
  const byte_t *key);
 ...
 * @since 0.0.1
 * @note It's a caller responsibility to u_free() the returned string after
 * usage.
 */
U_API byte_t *
u_inifile_parameter_string(const inifile_t *file, const byte_t *section,
 ...
 */
U_API int
u_inifile_parameter_int(const inifile_t *file, const byte_t *section,
 ...
 */
U_API double
u_inifile_parameter_double(const inifile_t *file, const byte_t *section,
...
U_API bool
u_inifile_parameter_boolean(const inifile_t *file, const byte_t *section,
 ...
 */
U_API list_t *
u_inifile_parameter_list(const inifile_t *file, const byte_t *section,
  const byte_t *key);
