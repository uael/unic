 ...
 * to free used memory manually, u_htable_free() will not do it in any way.
 *
 * Integers (up to 32 bits) can be stored in pointers using #U_POINTER_TO_INT
 * and #U_INT_TO_POINTER macros.
 */
#ifndef U_HTABLE_H__
# define U_HTABLE_H__
 ...
 * @since 0.0.1
 * @note Free with u_htable_free() after usage.
 */
U_API htable_t *
u_htable_new(void);
 ...
 * found.
 * @since 0.0.1
 * @note You should manually free the returned list with u_list_free() after
 * using it.
 */
U_API list_t *
 ...
 * found.
 * @since 0.0.1
 * @note Caller is responsible to call u_list_free() on the returned list after
 * usage.
 *
