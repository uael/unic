...
general_hash_test(hash_kind_t type,
  ...
  /* Stress test */
  p_crypto_hash_update(crypto_hash, (const ubyte_t *) long_str,
...
BOOST_AUTO_TEST_CASE (sha2_384_test) {
  const ubyte_t
    hash_etalon_1[] = {203, 0, 117, 63, 69, 163, 94, 139, 181, 160, 61, 105,
  ...
  const ubyte_t
    hash_etalon_2[] = {51, 145, 253, 221, 252, 141, 199, 57, 55, 7, 166, 91,
  ...
  const ubyte_t
    hash_etalon_3[] = {157, 14, 24, 9, 113, 100, 116, 203, 8, 110, 131, 78,
...
BOOST_AUTO_TEST_CASE (sha3_384_test) {
  const ubyte_t
    hash_etalon_1[] = {236, 1, 73, 130, 136, 81, 111, 201, 38, 69, 159, 88,
  ...
  const ubyte_t
    hash_etalon_2[] = {153, 28, 102, 87, 85, 235, 58, 75, 107, 189, 251, 117,
  ...
  const ubyte_t
    hash_etalon_3[] = {238, 233, 226, 77, 120, 193, 133, 83, 55, 152, 52, 81,
...
BOOST_AUTO_TEST_CASE (gost3411_94_test) {
  ...
  /* Repeat test */
  p_crypto_hash_update(gost3411_94_hash, (const ubyte_t *) "message digest",
    14);
  p_crypto_hash_update(gost3411_94_hash, (const ubyte_t *) "message digest",
    14);
  p_crypto_hash_update(gost3411_94_hash, (const ubyte_t *) "message digest",
  ...
  BOOST_CHECK (strcmp(hash_str,
    "1564064cce4fe1386be063f98d7ab17fc724fa7f02be4fa6847a2162be20d807") == 0);
  p_free(hash_str);
