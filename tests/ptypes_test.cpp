...
BOOST_AUTO_TEST_CASE (ptypes_host_network_test)
{
	...
	if (P_BYTE_ORDER == P_LITTLE_ENDIAN) {
		...
		BOOST_CHECK (PUINT64_FROM_BE (puint64_val) == (uint64_t) 0x0000000000000080ULL);
		BOOST_CHECK (PUINT64_TO_LE (puint64_val) == (uint64_t) 0x8000000000000000ULL);
		BOOST_CHECK (PUINT64_FROM_LE (puint64_val) == (uint64_t) 0x8000000000000000ULL);
		...
		if (PLIBSYS_SIZEOF_LONG == 8) {
			...
			BOOST_CHECK (PULONG_FROM_BE (pulong_val) == (ulong_t) 0x0000000000000800ULL);
			BOOST_CHECK (PULONG_TO_LE (pulong_val) == (ulong_t) 0x0008000000000000ULL);
			BOOST_CHECK (PULONG_FROM_LE (pulong_val) == (ulong_t) 0x0008000000000000ULL);
		} else {
		...
		if (PLIBSYS_SIZEOF_SIZE_T == 8) {
			...
			BOOST_CHECK (PSSIZE_FROM_BE (pssize_val) == (ssize_t) 0x000000000000F000LL);
			BOOST_CHECK (PSSIZE_TO_LE (pssize_val) == (ssize_t) 0x00F0000000000000LL);
			BOOST_CHECK (PSSIZE_FROM_LE (pssize_val) == (ssize_t) 0x00F0000000000000LL);
		} else {
		...
		BOOST_CHECK (puint64_val == (uint64_t) 0x8000000000000000ULL);
		BOOST_CHECK (PUINT64_FROM_LE (puint64_val) == (uint64_t) 0x0000000000000080ULL);
		BOOST_CHECK (PUINT64_TO_BE (puint64_val) == (uint64_t) 0x8000000000000000ULL);
		BOOST_CHECK (PUINT64_FROM_BE (puint64_val) == (uint64_t) 0x8000000000000000ULL);
		...
		if (PLIBSYS_SIZEOF_LONG == 8) {
			...
			BOOST_CHECK (pulong_val == (ulong_t) 0x0008000000000000ULL);
			BOOST_CHECK (PULONG_FROM_LE (pulong_val) == (ulong_t) 0x0000000000000800ULL);
			BOOST_CHECK (PULONG_TO_BE (pulong_val) == (ulong_t) 0x0008000000000000ULL);
			BOOST_CHECK (PULONG_FROM_BE (pulong_val) == (ulong_t) 0x0008000000000000ULL);
		} else {
		...
		if (PLIBSYS_SIZEOF_SIZE_T == 8) {
			...
			BOOST_CHECK (pssize_val == (ssize_t) 0x00F0000000000000LL);
			BOOST_CHECK (PSSIZE_FROM_LE (pssize_val) == (ssize_t) 0x000000000000F000LL);
			BOOST_CHECK (PSSIZE_TO_BE (pssize_val) == (ssize_t) 0x00F0000000000000LL);
			BOOST_CHECK (PSSIZE_FROM_BE (pssize_val) == (ssize_t) 0x00F0000000000000LL);
		} else {
	...
	BOOST_CHECK (puint64_val == (uint64_t) 0x8000000000000000ULL);
	BOOST_CHECK (PUINT64_SWAP_BYTES (puint64_val) == (uint64_t) 0x0000000000000080ULL);
